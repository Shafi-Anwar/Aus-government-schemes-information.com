      ...
      <div className="flex flex-col md:flex-row about-dc">
        ...
        <div className="md:w-64 w-[400px] bg-gray-900 p-[23px] text-white overflow-y-auto hidden md:block">
          <nav className="flex flex-col space-y-2 p-4">
            <Link href="#" className="text-xl font-bold text-gray-300 hover:text-white">About the department</Link>
            <ul className="list-none space-y-1">
              <li><Link href="#info" className="text-base hover:text-white">Information</Link></li>
              <li><Link href="#corporate" className="text-base hover:text-white">Corporate reporting</Link></li>
              <li><Link href="#" className="text-base hover:text-white">Our priorities</Link></li>
              <li><Link href="#" className="text-base hover:text-white">Our structure</Link></li>
              <li><Link href="#" className="text-base hover:text-white">Leadership</Link></li>
              <li><Link href="#" className="text-base hover:text-white">Locations</Link></li>
              <li><Link href="#" className="text-base hover:text-white">Contact us</Link></li>
            </ul>
          </nav>
        </div>
        ...
        <div className="flex-grow p-4">
          <div className=' mx-auto ' id='info'>
            ...
            <Link className='text-sky-500 font-medium underline' href="https://www.dewr.gov.au/about-department/our-ministers">Ministers for the Department of Employment and Workplace Relations.</Link>
            </li>
            </ol>
            ...
            <Link className='text-sky-500 font-medium underline' href="https://www.dewr.gov.au/about-department/our-ministers">The Secretary and executive for the Department of Employment and Workplace Relations are responsible for the delivery of the department’s services. </Link>
          </div>
          <div>
          ...
          <div className='items-center mt-4 ' id='corporate'>
            ...
            <Link href="https://www.dewr.gov.au/about-department/corporate-reporting/budget" className='text-left text-sky-500 hover:underline font-medium'>The Department's Portfolio Budget information for each financial year.</Link>
            <p className='text-left text-3xl mt-4 p-3  text-black font-medium'>Reconciliation Action Plan</p>
            <Link href="https://www.dewr.gov.au/about-department/reconciliation-action-plan" className='text-left text-sky-500 hover:underline font-medium'>The Department's Portfolio Budget information for each financial year.</Link>
          
            <p className='text-left text-3xl mt-4 p-3  text-black font-medium'>Corporate Reporting</p>
            <Link href="https://www.dewr.gov.au/about-department/corporate-reporting" className='text-left text-sky-500 hover:underline font-medium'>The Department's Portfolio Budget information for each financial year.</Link>
          
            <p className='text-left text-3xl mt-4 p-3  text-black font-medium'>Other Corporate Resources</p>
            <Link href="https://www.dewr.gov.au/resources/about-department" className='text-left text-sky-500 hover:underline font-medium'>The Department's Portfolio Budget information for each financial year.</Link>
